 ...
 * This script adds some sample feeds to a user account
 */
...
async function addFeedsToUser() {
  ...
  try {
    ...
    // 2. For now, let's just show what feeds are available
    ...
    // 3. Show how to add feeds manually
    console.log('\n3. To add feeds to your account, run this SQL in Supabase:');
    console.log(`
-- First, get your user ID:
SELECT id, email FROM auth.users LIMIT 5;

-- Then add some feeds (replace YOUR_USER_ID):
...
addFeedsToUser().catch(console.error); 